...
var parse = exports.parse = function parse(parser) {
    var as = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'body';
...
var parseJSON = exports.parseJSON = function parseJSON() {
    var propertyName = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'jsonData';
    return parse('json', propertyName);
};

// Deprecated.
var parseText = exports.parseText = function parseText() {
    var propertyName = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'textString';
...
var debug = exports.debug = function debug() {
    return function (fetch, input, options) {
        return fetch(input, options).then(function (response) {
            ...
            var error = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : new Error();
